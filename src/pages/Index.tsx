      ...
      <header className="absolute top-0 left-0 right-0 z-50 bg-white/10 backdrop-blur-sm border-b border-white/20">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-display font-bold text-white">VenueBook</span>
          </div>
      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-4">
          ...
          <div className="search-container max-w-4xl mx-auto">
            ...
            <Link to="/venues">
              <Button className="btn-hero w-full md:w-auto px-12 py-4 text-lg font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {howItWorks.map((item, index) => (
              <div key={item.step} className="text-center group">
                <div className="w-20 h-20 mx-auto mb-6 bg-gradient-gold rounded-full flex items-center justify-center shadow-gold group-hover:scale-105 transition-transform duration-300">
                ...
                {index < howItWorks.length - 1 && (
                  <div className="hidden md:block absolute top-10 left-full w-12 border-t-2 border-dashed border-secondary transform translate-x-1/2" />
                )}
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li><Link to="/venues" className="hover:text-secondary transition-colors">Browse Venues</Link></li>
                <li><Link to="#" className="hover:text-secondary transition-colors">How it Works</Link></li>
                <li><Link to="#" className="hover:text-secondary transition-colors">Reviews</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li><Link to="/owner/dashboard" className="hover:text-secondary transition-colors">List Your Venue</Link></li>
                <li><Link to="#" className="hover:text-secondary transition-colors">Owner Resources</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li><Link to="#" className="hover:text-secondary transition-colors">Help Center</Link></li>
                <li><Link to="#" className="hover:text-secondary transition-colors">Contact Us</Link></li>
                <li><Link to="#" className="hover:text-secondary transition-colors">Terms & Privacy</Link></li>
              </ul>
            </div>
          </div>
